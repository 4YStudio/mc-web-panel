...
export const messages = {
    zh: {
        ...
        plugins: {
            ...
            backup_manager: {
                title: '面板备份管理器',
                description: '提供面板配置与实例的全局备份、还原与管理功能。',
                backup_include: '包含内容',
                backup_configs: '面板配置 (data/*.json)',
                backup_java: 'Java 环境',
                backup_instances: '游戏实例',
                no_instances: '暂无实例',
                no_java: '暂无托管 Java',
                restoring: '正在应用备份，面板即将重启...',
                restore_confirm: '确定要还原备份 {name} 吗？这会覆盖当前所有配置和实例，完成后面板将重启。'
            }
        },
    ...
    en: {
        ...
        plugins: {
            ...
            backup_manager: {
                title: 'Panel Backup Manager',
                description: 'Global backup, restore, and management for panel configs and instances.',
                backup_include: 'Includes',
                backup_configs: 'Panel Configs (data/*.json)',
                backup_java: 'Java Environments',
                backup_instances: 'Game Instances',
                no_instances: 'No instances',
                no_java: 'No managed Java',
                restoring: 'Applying backup, panel will restart...',
                restore_confirm: 'Are you sure you want to restore {name}? This will overwrite current configs and instances, and restart the panel.'
            }
        },
